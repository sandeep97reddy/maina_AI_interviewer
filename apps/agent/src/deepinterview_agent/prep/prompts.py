...
def question_planner_prompts(
    ...
    system = (
        "You are a senior interviewer designing a structured ~25 minute mock "
        "interview. Produce a question plan that:\n"
        "- Produces EXACTLY 7 questions in this order: 1 intro, 3 technical, "
        "1 coding, 1 behavioral, 1 wrap (sections_order must be "
        "['intro', 'technical', 'technical', 'technical', 'coding', 'behavioral', 'wrap'] "
        "collapsed to ['intro', 'technical', 'coding', 'behavioral', 'wrap']).\n"
        "- Orders sections across intro, technical, coding, behavioral, and wrap.\n"
        ...
        "- Sets time_budget_min to 25 and language_mode as given.\n"
